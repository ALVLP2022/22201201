...
/**
        ...
        if(hours < "23:59:00"){
        var sayyingTime = 'Good Night'
}
        if(hours < "19:00:00"){
        var sayyingTime = 'Good Afternoon'
}
        if(hours < "18:00:00"){
        var sayyingTime = 'Good Afternoon'
}
        ...
        if(hours < "10:00:00"){
        var sayyingTime = 'Good Morning'
}
        if(hours < "05:00:00"){
        var sayyingTime = 'Good Morning'
}
        if(hours < "03:00:00"){
        var sayyingTime = 'Good Midnight'
}
	// auto set bio
...
const puasa = new Date('March 22 2023 00:0:01')
...
Selama ${clockString(new Date - user.afkTime)}`)
        ...
        const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 99999,status: 200, thumbnail: await reSize(thumb, 100, 100), surface: 200, message: `2201117TG`, orderTitle: '2201117TG', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: `2201117TG`,jpegThumbnail: await reSize(thumb, 100, 100)}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const ftextt = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})}, message: { "extendedTextMessage": {"text":`2201117TG`, "title": `${namabot}`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
        const ftoko = {key: {fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? {remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": await reSize(thumb, 100, 100)},"title": `2201117TG`, "description": `${namabot}`, "currencyCode": "IDR", "priceAmount1000": "1000000000000000000", "retailerId": `2201117TG`, "productImageCount": 1}, "businessOwnerJid": `0@s.whatsapp.net`}}} 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":`2201117TG`, "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': `2201117TG`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": `2201117TG`, "caption": `2201117TG`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: { "videoMessage": { "title":`2201117TG`, "h": `Hmm`,'seconds': '359996400', 'caption': `2201117TG`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const floc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `2201117TG`,jpegThumbnail: await reSize(thumb, 100, 100)}}}
		const floc2 = {key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {}) }, message: { "liveLocationMessage": { "title": `2201117TG`,"h": `Hmm`, 'jpegThumbnail': await reSize(thumb, 100, 100)}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': `2201117TG`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ytname,;;;\nFN:ytname\nitem1.TEL;waid=6289512545999:6289512545999\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': await reSize(thumb, 100, 100), thumbnail: await reSize(thumb, 100, 100),sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": `2201117TG`,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": await reSize(thumb, 100, 100),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
let teks_daftar =`*──────❲ VERIFICATION SUKSES ❳──────*
*Name :* ${m1}
*Umur :* ${m2} Tahun
*Gender :* ${m3}
*Resi :* ${resiNya}
...
fs.writeFileSync('./database/user.json', JSON.stringify(user))
gans.sendMessage(sender, { text: `*Loading Data* › @${sender.split('@')[0]}`, mentions: [ `${sender.split('@')[0]}@s.whatsapp.net` ]}, { quoted: m })
...
break
            ...
            let me = m.sender
            let menu = `
*Hello ${pushname}, How I can help you*,`
let menunya = `
*2201117 | Build Operate Transfer | OpenAI*
Develop : 2201117TG
...
${symbol2} ${prefix}delete (msg) `
      	  let buttons = [
                    {buttonId: `8272`, buttonText: {displayText: '******'}, type: 1}
                ]
                let buttonMessage = {
                    image: pic2,
                    caption: `${menu}`,
...
var atas = q.split('|')[0]
var bawah = q.split('|')[1]
if (!atas) return m.reply(`Send Image with caption ${prefix+command} packname|author or reply image`)
if (!bawah) return m.reply(`Send Image with caption ${prefix+command} packname|author or reply image`)
...
var opt = { packname: 'Firefox', author: '2201117TG' }
gans.sendImageAsSticker(m.chat, meme_url, m, opt)
fs.unlinkSync(media)
} else {
m.reply(`Send Image with caption ${prefix+command} packname|author or reply image`)
}
break
            case 'ebinary': {
...
if (!quoted) return m.reply( `Send Image with caption ${prefix+command}`)
if (!/image/.test(mime)) return m.reply( `Send Image with caption ${prefix+command}`)
if (/webp/.test(mime)) return m.reply( `Send Image with caption ${prefix+command}`)
...
break
		case 'menfes': case 'menfess': {
		        ...
		        if (m.isGroup) throw ('Important : Please Use In Private Chat')
            	if (!text) throw `Example : ${prefix + command} 6282xxxxx|name|message`
            var mon = args.join(' ')
            var m1 = mon.split("|")[0]
            var m2 = mon.split("|")[1]
            var m3 = mon.split("|")[2]
               let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: 'Your Location', jpegThumbnail: thumb}}}
               let mq1 = m1 + '@s.whatsapp.net'
               let kawk = ('Someone Send Message')
               let ownernya = owner + '@s.whatsapp.net'
               let me = m.sender
               let ments = [mq1, ownernya, me]
               let ivg = `https://telegra.ph/file/11ad4ee7a5b6fd2d5fcfa.jpg`
               let pjtxt = `Hi There is Menfess here!!\n─────────────\n*${namabot}*\n─────────────\n\nFrom : _${m2}_ \nMessage : _${m3}_`
               let buttons = [
                { buttonId: 'chatwith2 ${sender.replace("@s.whatsapp.net", "")}', buttonText: { displayText: 'Reply Menfes' }, type:1 },
                { buttonId: 'menfess', buttonText: { displayText: 'Send Menfes' }, type: 1 }]
               let but = [{ buttonId: 'menfess', buttonText: { displayText: 'Wanna Send Menfes Again?' }, type: 1 }]
            await gans.sendMessage(m1 + '@s.whatsapp.net', { caption: pjtxt, location: { jpegThumbnail: await reSize(ivg, 300, 200)}, buttons, footer: `Hi There is Menfess here\n${global.wm}`}, {quoted: ftroli})
            let akhji = `Message Send\nTo @${mq1.split('@')[0]}`
            await gans.sendButtonText(m.chat, but, akhji, nyoutube, m, {mentions: ments})
            }
            break
        case 'menfes_confirm': {
        
 				gans.sendMessage(q, {text: ` Message Confirmed`})
				 m.reply(`Thank you Menfess being accepted.`)
				}
