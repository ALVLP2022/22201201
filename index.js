...
console.log(color(figlet.textSync('2201117TG', {
		font: 'Small',
	...
	console.log(color(`${spc2}           [ 2.23.1.11 ]` ,`${randomcolor}`))
	console.log(color(`${spc4}                       < =============================== >`, `${randomcolor}`))
	console.log(color(`${spc3}                    [•]`, `${randomcolor}`), color(`Hello      : ${namabot}    `, `${randomcolor}`))
    ...
    const gans = WaConnect({
        ...
        browser: ['2201117TG','Firefox','5.9.9'],
        auth: state,
        version
    })
